...
✅ **Part A - Installation:**
- MongoDB Atlas (SaaS)
- EC2 Instance mit Java Shop App
- Nginx als Reverse Proxy
- Cloud-Init Automatisierung

✅ **Part B - Vertikale Skalierung:**
- Disk: 8 GB → 20 GB (online)
- Instance Type: t2.micro → t2.medium (offline)

✅ **Part C - Horizontale Skalierung:**
- 2 Web Server Instances
- Application Load Balancer
- Target Group mit Health Checks
- DNS-basierter Zugriff

✅ **Part D - Auto Scaling:**
- Launch Template
- Auto Scaling Group (2-5 Instances)
- Automatisches Healing bei Instance-Ausfall
...
**Cloud-Init Datei**: `cloud-init-web-java.yaml`

**Wichtige Komponenten:**
- Package Installation: nginx, openjdk-17, mongodb-mongosh
- MongoDB Datenimport via mongosh
- Systemd Service für Java App
- Nginx Reverse Proxy Konfiguration

**AWS Services verwendet:**
- EC2 (Elastic Compute Cloud)
- ELB (Elastic Load Balancing) - Application Load Balancer
- Auto Scaling
- VPC & Security Groups
...
✅ Web API in Betrieb genommen und Service erstellt  
✅ Reverse Proxy (Nginx) konfiguriert  
✅ SaaS Datenbank (MongoDB Atlas) verwendet  
✅ Vertikale Skalierung (Disk & CPU/RAM) durchgeführt  
✅ Horizontale Skalierung mit Load Balancer implementiert  
✅ Auto Scaling für automatisches Healing konfiguriert  
✅ Cloud-Init für komplexe Deployments verwendet  

---

**Autor**: Thomas Stern  
**Datum**: 13. Januar 2026  
**Modul**: M346 - Cloud Services
